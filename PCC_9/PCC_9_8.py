...
class User_Privileges():
    ...
    def __init__(self, user_privileges = []):
        self.user_privilges = user_privileges
...
first_admin.user_privileges.show_privileges()
first_admin.user_privileges =["can add post", "can delete post", "can ban user"]
first_admin.user_privileges.show_privileges()

second_admin.user_privileges = []
second_admin.user_privileges.show_privileges()